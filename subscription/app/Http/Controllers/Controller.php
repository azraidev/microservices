...
class Controller extends BaseController
{
    ...
    public function __construct(){
        $this->cert = Storage::disk('public')->get('public.pem');
        $this->ssl = Storage::disk('public')->get('cert.pem');
    }
    ...
    public function executeAPI($api){
        ...
        $clientParam[RequestOptions::AUTH] = $this->cert;
        $clientParam[RequestOptions::SSL_KEY] = $this->ssl;
